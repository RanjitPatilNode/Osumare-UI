  ...
  <div className="max-w-7xl mx-auto px-4 py-16">
    ...
    <div className="flex flex-wrap items-center justify-center">
      <div className="w-full md:w-1/2 px-4">
        ...
        <div className="border p-6 rounded-lg mb-6 shadow-md flex">
          <div className="text-3xl mr-4"><img src="realtwo.png" alt="img" /></div>
          <div>
        ...
        <div className="border p-6 rounded-lg mb-6 shadow-md flex">
          <div className="text-3xl mr-4"><img src="realthree.png" alt="img" /></div>
          <div>
        ...
        <div className="border p-6 rounded-lg mb-6 shadow-md flex">
          <div className="text-3xl mr-4"><img src="realfour.png" alt="img" /></div>
          <div>
      ...
      <div className="w-full md:w-1/2 px-4 h-[80vh] flex justify-center">
        <img
          src="mfive.png"
          alt="Placeholder"
