    ...
    <div className="flex flex-col items-center justify-center py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 ">
        <div className="flex flex-col items-center text-center p-4">
          <img src="action1.png" alt="v6 logo" className="mb-3 " />
        ...
        <div className="flex flex-col items-center text-center p-4 mt-10 ">
          <img src="action2.png" alt="v2logo" className="mb-3  " />
          <h2 className="text-xl font-bold mb-2 mt-10">Conversion-Optimized Landing Pages</h2>
          <p className="text-gray-600">
        ...
        <div className="flex flex-col items-center text-center p-4  ">
          <img src="action3.png" alt="logov3" className="mb-4 " />
        ...
        <div className="flex flex-col items-center text-center p-4 ">
          <img src="action4.png" alt="v3logo" className="mb-4" />
          <h2 className="text-xl font-bold mb-2 mt-14">Mobile-First Success:</h2>
          <p className="text-gray-600">
      ...
      <div style={{ width: "25rem", justifyContent: "center", alignItems: "center" }}>
        <h1 className="text-2xl font-bold mb-4 text-center"> <br />
      ...
      <button className="bg-blue-500 text-white px-7 py-2 rounded-full ">
        Get started
      </button>
