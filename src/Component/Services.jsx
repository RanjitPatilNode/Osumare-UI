  ...
  <div style={{ background: "rgba(249, 249, 249, 1)" }}>
    <div className="max-w-7xl mx-auto px-4 py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {services.map((item, i) => (
          <div key={i} className="border p-4 rounded-lg text-center shadow-md">
            <div className="text-4xl mb-5"><img src={item.iconimg} alt="img" style={{marginLeft:"50%"}} /></div>
      ...
      <div className="text-center mt-12">
        <button className="bg-blue-600 text-white px-7 py-2 rounded-full shadow-lg hover:bg-blue-700 transition">
          Get started
        </button>
      </div>
    </div>
